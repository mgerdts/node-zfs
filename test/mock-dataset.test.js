...
tap.test('Dataset', (tt) => {
    ...
    tt.test('catch new implementations', (t) => {
        ...
        let props = [ 'aclinherit', 'acltype', 'casesensitivity', 'context',
            ...
            'mlslabel', 'mounted', 'nmbmand', 'normalization', 'objsetid',
            'overlay', 'pbkdf2iters', 'primarycache', 'quota', 'readonly',
            'recordize', 'redundant_metadata', 'refcompressratio', 'referenced',
            'refquota', 'refreservation', 'relatime', 'reservation',
            'rootcontext', 'secondarycache', 'setuid', 'sharenfs', 'sharesmb',
            'size', 'snapdev', 'snapdir', 'snapshot_count', 'snapshot_limit',
